...
int main()
{
	...
	// TEST KBCAST8 ----------------------------------------------------------------------------	
	res8=kless_scalar_broadcast_8((void*) result8, (void*) dest, (void*) scal8, size8);
	//------------------------------------------------------------------------------------------
	...
	// TEST KBCAST16 ---------------------------------------------------------------------------
	res16=kless_scalar_broadcast_16((void*) result16, (void*) dest, (void*) scal16, size16);
	//------------------------------------------------------------------------------------------
	// DISABLE COUNTING AND SAVE MCYCLE OF EACH THREAD ////////
	__asm__("csrrw zero, 0x7A0, 0x00000000;"
	...
	// TEST KBCAST --------------------------------------------------------------------------------	
	res32=kless_scalar_broadcast_32((void*) result32, (void*) dest, (void*) scal32, size32);
	//--------------------------------------------------------------------------------------------
