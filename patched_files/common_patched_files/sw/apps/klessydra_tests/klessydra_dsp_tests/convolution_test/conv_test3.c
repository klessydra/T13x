...
int main()
{
  ...
  // display_spm_matrix(A_ORDER,A_ORDER, (void*)spmaddrB);
  // display_spm_matrix(B_ORDER,B_ORDER, (void*)spmaddrB);
  // CSR_MVSIZE((A_ORDER*A_ORDER)*sizeof(int));
	// ksvmulrf32((void*)spmaddrD,			(void*)	( (int*)spmaddrB ),	(void*)((int*)single_value));
  // kmemld((void*)spmaddrD, (void*)clean, dimension_A); //così da riempire preventivamente la scpm con valori zero
  ...
  CSR_MVSIZE((A_ORDER*A_ORDER)*sizeof(int));
  ksvmulrf32((void*)spmaddrD,			(void*)	( (int*)spmaddrC ),	(void*)((int*)single_value));
	kmemld((void*)spmaddrC, (void*)clean, dimension_A); //così da riempire preventivamente la scpm con valori zero
  ksvmulrf32((void*)spmaddrC,			(void*)	( (int*)spmaddrD ),	(void*)((int*)single_value));
