...
int main()
{
	...
	// TEST KRELU8 ----------------------------------------------------------------------------	
	res8=kless_rectify_linear_unit((void*) result8, (void*) vect8_1, size8);
	//------------------------------------------------------------------------------------------
	...
	// TEST KRELU16 ---------------------------------------------------------------------------
	res16=kless_rectify_linear_unit((void*) result16, (void*) vect16_1, size16);
	//------------------------------------------------------------------------------------------
	// DISABLE COUNTING AND SAVE MCYCLE OF EACH THREAD ////////
	__asm__("csrrw zero, 0x7A0, 0x00000000;"
	...
	// TEST KRELU --------------------------------------------------------------------------------	
	res32=kless_rectify_linear_unit((void*) result32, (void*) vect32_1, size32);
	//--------------------------------------------------------------------------------------------
