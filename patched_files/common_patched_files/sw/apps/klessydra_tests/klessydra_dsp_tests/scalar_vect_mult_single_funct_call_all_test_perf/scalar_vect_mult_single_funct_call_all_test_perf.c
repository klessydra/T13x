...
#define NumOfElements 32
#define NumOfThreads 3

unsigned char  vect8_1[NumOfElements] = {0xFF, 0xEE, 0xDD, 0xCC, 0xBB, 0xAA, 0x99, 0x88, 0xFF, 0xEE, 0xDD, 0xCC, 0xBB, 0xAA, 0x99, 0x88, 0xFF, 0xEE, 0xDD, 0xCC, 0xBB, 0xAA, 0x99, 0x88, 0xFF, 0xEE, 0xDD, 0xCC, 0xBB, 0xAA, 0x99, 0x88};
...
unsigned int   *res16;
unsigned int   *res32;
unsigned char  result8[2*NumOfElements];		// AAA change this if the result width in klessydra is ever changed
unsigned short result16[2*NumOfElements];		// AAA change this if the result width in klessydra is ever changed
unsigned int   result32[2*NumOfElements];		// AAA change this if the result width in klessydra is ever changed
...
{	
	...
	if (Klessydra_get_coreID()==1)
	{
		...
		for (int i=0; i<NumOfElements; i++)
		{
			if (res32[2*i]==testres32[i])  // AAA change this if the result width in klessydra is ever changed
			{
				mult_pass++;
			}
			else 
