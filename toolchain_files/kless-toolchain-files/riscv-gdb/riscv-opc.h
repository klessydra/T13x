...
#define MATCH_K_VSLT    0x3400202b
#define MATCH_K_SVSLT   0x3800202b
...
DECLARE_INSN(kbcastld, MATCH_K_BCASTLD, MASK_K_MEM)
DECLARE_INSN(kaddv, MATCH_K_ADDV, MASK_K_ARITH)
DECLARE_INSN(ksubv, MATCH_K_SUBV, MASK_K_ARITH)
DECLARE_INSN(kvmul, MATCH_K_VMUL, MASK_K_ARITH)
DECLARE_INSN(kvred, MATCH_K_VRED, MASK_K_ARITH)
DECLARE_INSN(kdotp, MATCH_K_DOTP, MASK_K_ARITH)
DECLARE_INSN(ksvaddsc, MATCH_K_SVADDSC, MASK_K_ARITH)
DECLARE_INSN(ksvaddrf, MATCH_K_SVADDRF, MASK_K_ARITH)
DECLARE_INSN(ksvmulsc, MATCH_K_SVMULSC, MASK_K_ARITH)
DECLARE_INSN(ksvmulrf, MATCH_K_SVMULRF, MASK_K_ARITH)
DECLARE_INSN(ksrav, MATCH_K_SRAV, MASK_K_ARITH)
DECLARE_INSN(ksrlv, MATCH_K_SRLV, MASK_K_ARITH)
DECLARE_INSN(krelu, MATCH_K_RELU, MASK_K_ARITH)
DECLARE_INSN(kvslt, MATCH_K_VSLT, MASK_K_ARITH)
DECLARE_INSN(ksvslt, MATCH_K_SVSLT, MASK_K_ARITH)
DECLARE_INSN(kdotpps, MATCH_K_DOTPPS, MASK_K_ARITH)
DECLARE_INSN(kbcast, MATCH_K_BCAST, MASK_K_ARITH)
