...
*/
DECLARE_INSN(kmemld, MATCH_K_MEMLD, MASK_K_MEMLD)
DECLARE_INSN(kmemstr, MATCH_K_MEMSTR, MASK_K_MEMSTR)
DECLARE_INSN(kaddv32, MATCH_K_ADDV32, MASK_K_ADDV)
DECLARE_INSN(kaddv16, MATCH_K_ADDV16, MASK_K_ADDV)
DECLARE_INSN(kaddv8 , MATCH_K_ADDV8 , MASK_K_ADDV)
DECLARE_INSN(ksubv32, MATCH_K_SUBV32, MASK_K_SUBV)
DECLARE_INSN(ksubv16, MATCH_K_SUBV16, MASK_K_SUBV)
DECLARE_INSN(ksubv8 , MATCH_K_SUBV8 , MASK_K_SUBV)
DECLARE_INSN(kdotp32, MATCH_K_DOTP32, MASK_K_DOTP)
DECLARE_INSN(kdotp16, MATCH_K_DOTP16, MASK_K_DOTP)
DECLARE_INSN(kdotp8 , MATCH_K_DOTP8 , MASK_K_DOTP)
DECLARE_INSN(ksvmul32, MATCH_K_SVMUL32, MASK_K_SVMUL)
DECLARE_INSN(ksvmul16, MATCH_K_SVMUL16, MASK_K_SVMUL)
DECLARE_INSN(ksvmul8 , MATCH_K_SVMUL8 , MASK_K_SVMUL)
#endif
#ifdef DECLARE_CSR
